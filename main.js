...
.project-button, .submit-button, .submit-project-button{
    background-color: rgb(40, 38, 38);
    color: white;
    border: solid 1px rgb(40, 38, 38);
    border-radius: 0.5em;
    padding: 0.5em;
    width: 10em;
}
...
.project-delete-button img{
    width: 1em;
    height: 1em;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,iCAAiC;IACjC,gBAAgB;IAChB,kBAAkB;EACpB;;AAEF;IACI,sBAAsB;IACtB,SAAS;IACT,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,aAAa;IACb,2BAA2B;IAC3B,qBAAqB;AACzB;;AAEA;IACI,eAAe;IACf,iCAAiC;IACjC,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,mBAAmB;IACnB,gBAAgB;IAChB,MAAM;IACN,WAAW;AACf;;AAEA;IACI,sBAAsB;IACtB,eAAe;IACf,aAAa;IACb,8BAA8B;IAC9B,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,8BAA8B;IAC9B,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,gBAAgB;IAChB,aAAa;IACb,MAAM;IACN,uBAAuB;AAC3B;;AAEA;IACI,eAAe;IACf,aAAa;IACb,sBAAsB;IACtB,QAAQ;AACZ;;AAEA;IACI,WAAW;IACX,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kBAAkB;IAClB,WAAW;IACX,YAAY;IACZ,aAAa;IACb,wDAAwD;IACxD,2BAA2B;IAC3B,mBAAmB;IACnB,UAAU;IACV,gBAAgB;IAChB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,WAAW;IACX,uBAAuB;IACvB,uBAAuB;IACvB,8BAA8B;IAC9B,YAAY;IACZ,8BAA8B;IAC9B,kBAAkB;IAClB,gBAAgB;AACpB;;AAEA;IACI;AACJ;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,WAAW;AACf;;AAEA;IACI,qBAAqB;IACrB,YAAY;IACZ,WAAW;IACX,WAAW;IACX,cAAc;IACd,qBAAqB;IACrB,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,QAAQ;IACR,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,iCAAiC;IACjC,YAAY;IACZ,iCAAiC;IACjC,oBAAoB;IACpB,cAAc;IACd,WAAW;AACf;;AAEA;IACI,sBAAsB;IACtB,oBAAoB;IACpB,wCAAwC;AAC5C;;AAEA;IACI,YAAY;IACZ,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,UAAU;IACV,WAAW;AACf","sourcesContent":[".roboto-regular {\n    font-family: \"Roboto\", sans-serif;\n    font-weight: 400;\n    font-style: normal;\n  }\n\n*{\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n}\n\nbody{\n    width: 100vw;\n    height: 100vh;\n    display: grid;\n    grid-template-rows: 1fr 6fr;\n    font-family: 'Roboto';\n}\n\nheader{\n    grid-row: 1 / 2;\n    background-color: rgb(40, 38, 38);\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    color: antiquewhite;\n    position: sticky;\n    top: 0;\n    z-index: 10;\n}\n\n.main-container{\n    color: rgb(40, 38, 38);\n    grid-row: 2 / 3;\n    display: grid;\n    grid-template-columns: 2fr 4fr;\n    height: 100%;\n}\n\n.form-container{\n    grid-column: 1 / 2;\n    background-color: antiquewhite;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    position: sticky;\n    height: 100vh;\n    top: 0;\n    /* overflow-y: auto;  */\n}\n\n.form, .project-form{\n    margin-top: 1em;\n    display: flex;\n    flex-direction: column;\n    gap: 1em;\n}\n\n.form-element{\n    width: 100%;\n    display: flex;\n    justify-content: space-between;\n}\n\nlabel{\n    margin-right: 1em;\n}\n\ninput{\n    padding: 0.3em;\n}\n\n.todos-main-container{\n    grid-column: 2 / 3;\n    width: 100%;\n    height: 100%;\n    display: grid;\n    grid-template-rows: repeat(auto-fit, minmax(100px, 1fr));\n    justify-content: flex-start;\n    align-items: center;\n    gap: 0.3em;\n    overflow-y: auto;\n    padding: 2em;\n}\n\n.todo-ele{\n    display: flex;\n    flex-direction: column;\n    width: 20em;\n    justify-content: center;\n    align-items: flex-start;\n    background-color: antiquewhite;\n    padding: 1em;\n    border: solid 1px antiquewhite;\n    border-radius: 1em;\n    margin-left: 5em;\n}\n\n.todo-div p{\n    color: #808080\n}\n\n.todo-div{\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    width: 100%;\n}\n\n.delete-button{\n    background-color: red;\n    color: white;\n    width: 10em;\n    height: 3em;\n    padding: 0.5em;\n    border: solid 1px red;\n    border-radius: 0.5em;\n}\n\n.projects-container{\n    display: flex;\n    flex-direction: column;\n    gap: 1em;\n    margin-bottom: 1em;\n    width: 12em;\n}\n\n.project-container{\n    display: flex;\n    justify-content: space-between;\n}\n\n.project-button, .submit-button, .submit-project-button{\n    background-color: rgb(40, 38, 38);\n    color: white;\n    border: solid 1px rgb(40, 38, 38);\n    border-radius: 0.5em;\n    padding: 0.5em;\n    width: 10em;\n}\n\ninput{\n    border: solid 1px #ccc;\n    border-radius: 0.5em;\n    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2);\n}\n\n.project-delete-button{\n    border: none;\n    background:none;\n    margin-left: -1em;\n}\n\n.project-delete-button img{\n    width: 1em;\n    height: 1em;\n}"],"sourceRoot":""}]);
// Exports
...
function render() {
    ...
    projects.forEach((project) => {
        ...
        const project_delete_button = document.createElement('button');
        project_delete_button.classList.add('project-delete-button');
        project_delete_button.innerHTML = `<img src="${_delete_png__WEBPACK_IMPORTED_MODULE_1__}"/>`;
...
function addInitialProjects() {
    ...
    const defaultTodo1 = new Todo("Neetcode", "Practice neetcode 150", 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 9, 11), "yyyy-MM-dd"));
    const defaultTodo2 = new Todo("Neetcode", "Practice neetcode 150", 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 9, 11), "yyyy-MM-dd"));
    const defaultTodo3 = new Todo("Neetcode", "Practice neetcode 150", 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 9, 11), "yyyy-MM-dd"));
    ...
    const todo1 = new Todo("Leetcode", "Practice Blind 75", 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 9, 11), "yyyy-MM-dd"));
    const todo2 = new Todo("Sql", "Practice SQL from W3S", 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(2024, 9, 11), "yyyy-MM-dd"));
